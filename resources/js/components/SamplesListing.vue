  ...
  methods: {
      ...
      switch (action) {
        ...
        case 'remove-item':
          ProcessMaker.confirmModal(
            ...
            '',
            () => {
              ProcessMaker.apiClient.delete(`admin/connectors/${data.id}`).then(() => {
    ...
    fetch() {
      ...
      ProcessMaker.apiClient
        .get(
          `admin/connectors/fetch?page=${this.page}&per_page=${this.perPage}&filter=${this.filter}&order_by=${this.orderBy}&order_direction=${this.orderDirection}`,
        )
        .then((response) => {
